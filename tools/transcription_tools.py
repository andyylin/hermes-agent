...
def transcribe_audio(file_path: str, model: Optional[str] = None) -> Dict[str, Any]:
    ...
    return {
        ...
        "error": (
            ...
            "set VOICE_TOOLS_OPENAI_KEY or OPENAI_API_KEY for the OpenAI Whisper API, "
            "or authenticate with `hermes auth openai-codex` and set stt.provider: openai-codex."
        ),
    }
