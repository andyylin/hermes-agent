...
COMPUTER_USE_SCHEMA: Dict[str, Any] = {
    ...
    "description": (
        ...
        "keyboard focus, or virtual desktop. Supported on macOS, Windows, "
        "and Linux. Preferred workflow: call with "
        ...
        "hidden, minimized, on another virtual desktop, or behind another app. "
