...
export const zh: Translations = {
  ...
  sidebar: {
    ...
    projects: {
      ...
      newButton: '新建项目',
      createTitle: '新建项目',
      createDesc: '为工作区命名并选择文件的存放位置。',
      managedOption: '创建文件夹',
      managedOptionDesc: '由 Hermes 管理',
      existingOption: '使用现有文件夹',
      existingOptionDesc: '选择文件夹',
      managedFolderNote: 'Hermes 会在此配置档案的 projects 目录下创建专用文件夹。',
      renameTitle: '重命名项目',
      ...
      createFailed: '无法创建项目',
      managedUnsupported: '请更新 Hermes 后端以创建托管项目文件夹。',
