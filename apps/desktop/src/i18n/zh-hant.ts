...
export const zhHant = defineLocale({
  ...
  sidebar: {
    ...
    projects: {
      ...
      newButton: '新增專案',
      createTitle: '新增專案',
      createDesc: '為工作區命名並選擇檔案的儲存位置。',
      managedOption: '建立資料夾',
      managedOptionDesc: '由 Hermes 管理',
      existingOption: '使用現有資料夾',
      existingOptionDesc: '選擇資料夾',
      managedFolderNote: 'Hermes 會在此設定檔的 projects 目錄下建立專用資料夾。',
      renameTitle: '重新命名專案',
      ...
      createFailed: '無法建立專案',
      managedUnsupported: '請更新 Hermes 後端以建立受管理的專案資料夾。',
