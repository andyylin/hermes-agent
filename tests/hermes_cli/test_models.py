...
class TestFetchOpenRouterModels:
    def test_live_fetch_recomputes_free_tags(self, monkeypatch):
        ...
        # Pin the remote manifest. Otherwise preferred_ids come from the
        # currently deployed catalog and these IDs can silently disappear.
        pinned = [
        ...
        with (
            patch("hermes_cli.model_catalog.get_curated_openrouter_models", return_value=pinned),
