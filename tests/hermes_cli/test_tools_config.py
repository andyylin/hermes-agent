...
def test_memory_tree_is_plugin_owned_not_builtin_configurator_entry():
    """Memory Tree moved to ~/.hermes/plugins/memory-tree; not a core toolset."""
    ...
    assert "memory_tree" not in keys
    assert "memory_tree" not in _DEFAULT_OFF_TOOLSETS
