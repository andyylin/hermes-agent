...
from cron.scheduler import _resolve_origin, _resolve_delivery_target, _deliver_result, _send_media_via_adapter, run_job, SILENT_MARKER, _build_job_prompt, _format_cron_delivery_content, _resolve_cron_enabled_toolsets, _merge_mcp_into_per_job_toolsets
...
class TestRoutingIntents:
    ...
    def test_all_with_no_connected_channels_returns_empty(self, monkeypatch):
        ...
        for var in ("TELEGRAM_HOME_CHANNEL", "DISCORD_HOME_CHANNEL", "SLACK_HOME_CHANNEL",
                    ...
                    "LINE_HOME_CHANNEL", "WHATSAPP_HOME_CHANNEL", "WHATSAPP_CLOUD_HOME_CHANNEL"):
    ...
    def test_all_token_case_insensitive(self, monkeypatch):
        ...
        monkeypatch.delenv("WHATSAPP_CLOUD_HOME_CHANNEL", raising=False)
...
class TestDeliverResultWrapping:
    ...
    def test_live_adapter_private_telegram_topic_uses_direct_messages_topic_id(self):
        ...
        with patch("gateway.config.load_gateway_config", return_value=mock_cfg), \
             patch("gateway.delivery.DeliveryRouter._deliver_to_platform", new_callable=AsyncMock) as deliver_mock, \
        ...
        target, text, metadata = deliver_mock.call_args.args
        assert target.chat_id == "545944400"
